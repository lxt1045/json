...
type UserEntities struct {
	URL         URL          `json:"url"`
	Description Description1 `json:"description"`
}
...
var TwitterJsonLarge = func() string {
	file := "/Users/bytedance/go/src/github.com/lxt1045/json/testdata/twitter.json"
...
var TwitterJsonLargeEscaped = func() string {
	file := "/Users/bytedance/go/src/github.com/lxt1045/json/testdata/twitterescaped.json"
	bs, err := ioutil.ReadFile(file)
	if err != nil {
		panic(err)
	}
...
var TwitterJson = func() string {
	file := "/Users/bytedance/go/src/github.com/lxt1045/json/testdata/twitter_middle.json"
	bs, err := ioutil.ReadFile(file)
	if err != nil {
		panic(err)
	}
